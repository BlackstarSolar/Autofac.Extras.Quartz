...
namespace Autofac.Extras.Quartz
{
    ...
    {
        [NotNull] static readonly ILog s_log = LogProvider.GetLogger(typeof(AutofacJobFactory));
        [NotNull] readonly ILifetimeScope _lifetimeScope;

        [NotNull] readonly string _scopeName;
        ...
        public IJob NewJob(TriggerFiredBundle bundle, IScheduler scheduler)
        {
            ...
            try
            {
                ...
                {
                    s_log.TraceFormat("Scope 0x{0:x} associated with Job 0x{1:x}",
        ...
        static void DisposeScope([CanBeNull] IJob job, [CanBeNull] ILifetimeScope lifetimeScope)
        {
            if (s_log.IsTraceEnabled())
            {
        ...
        internal sealed class JobTrackingInfo
        {
            ...
            /// </summary>
            public JobTrackingInfo([NotNull] ILifetimeScope scope)
            {
                Scope = scope;
            }
